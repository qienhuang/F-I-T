...
Status: **core-compatible extension**  
Applies to: complex adaptive systems  
...
1. **Constraint hardening**: constraint growth outpaces information renewal  
2. **Force homogenization**: new challenges are met with larger quantities of the same Force  
3. **Information ossification**: Information remains stable but cannot regenerate  

Outcome:

- short-term stability
- medium-term diminishing returns
- long-term structural breakdown, displacement, or absorption
...
A new Force emerges at a higher abstraction level, not directly competing with existing Force at the same level.
...
Existing constraints are preserved and embedded as sub-constraints (rather than destroyed).

Outcome:

- surface stability persists
- a new layer enters exploratory dynamics
- cross-generational adaptability emerges
...
One question distinguishes the two paths:
...
## 8) Common misinterpretations (avoid)
...
It only describes structural possibility space.

## 10) Relation to FIT core
