...
>
> This file is preserved as the original FIT v2.4 specification for historical traceability.
> It is **not** the recommended primary reading path for the current FIT 2.x line.
>
> **Read this instead**
> - Current integrated specification: [`spec_current.md`](./spec_current.md)
> - Update rationale / delta note: [`v2.4.1.md`](./v2.4.1.md)
>
> This snapshot remains preserved to satisfy FIT versioning discipline:
> no silent semantic shifts, and deprecated statements must remain explicitly preserved for traceability.
>
