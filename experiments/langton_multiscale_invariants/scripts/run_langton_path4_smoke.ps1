...
Invoke-Py "python scripts/generate_multiscale_long_dataset.py --seeds 2 --seed_start 9000 --steps 4000 --burn_in 500 --measure_interval 20 --window 30 --view_size 128"
...
Write-Host "Langton Path-4 smoke run complete."
