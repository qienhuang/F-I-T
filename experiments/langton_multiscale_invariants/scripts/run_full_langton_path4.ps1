...
Invoke-Py "python scripts/generate_multiscale_long_dataset.py --seeds 6 --seed_start 7000 --steps 12000 --burn_in 800 --measure_interval 20 --window 40 --view_size 128"
...
Write-Host "Langton Path-4 full run complete."
