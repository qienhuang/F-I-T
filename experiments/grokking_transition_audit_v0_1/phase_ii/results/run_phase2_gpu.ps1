...
python -m grokking.runner.sweep --spec "D:\FIT Lab\github\F-I-T\experiments\grokking_transition_audit_v0_1\phase_ii\results\specs\estimator_spec.phase2_checkpoints.yaml" --out "D:\FIT Lab\grokking\runs_v0_6_structural_phase2" --phase eval
