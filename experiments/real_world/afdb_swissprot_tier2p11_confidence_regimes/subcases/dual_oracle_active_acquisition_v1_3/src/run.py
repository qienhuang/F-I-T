...
def main() -> None:
    ...
    for spec in policy_specs:
        ...
        pae_series = {"queried_labels": [], "tpr_primary": [], "fpr_primary": [], "fpr_floor_at_tpr_min": [], "trained": []}
        msa_cls_series = {"queried_labels": [], "tpr_primary": [], "fpr_primary": [], "fpr_floor_at_tpr_min": [], "trained": []}
    ...
    lines: List[str] = []
    lines.append("# Eval report — Dual‑Oracle + Δ‑Lag + Leakage Audit (v1.3)\n\n")
    ...
    footer = (
        f"subcase=dual_oracle_active_acquisition_v1_3 | parent=afdb_swissprot_tier2p11_confidence_regimes | "
