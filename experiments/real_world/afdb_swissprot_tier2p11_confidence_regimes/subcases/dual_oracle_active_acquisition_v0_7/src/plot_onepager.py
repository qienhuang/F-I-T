...
def plot_onepage_v0_7(
    ...
    axA.set_title("(A) PAE alarm learning curve (holdout TPR@cap vs PAE budget)")
    ...
    axB.set_title("(B) MSA alarm learning curve (holdout TPR@cap vs MSA budget)")
    ...
    axD.set_title("(D) Joint gate frontier (holdout): speed vs proxy quality")
