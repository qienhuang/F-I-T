# REPRO_CHECKLIST — Dual‑Oracle + Regime Diagnostics (v1.0)
...
## 6) Regime diagnostics checks (must pass)
...
## 7) Alpha/K audit checks (must pass)
...
## 8) Monitorability hardness (FPR floors)
