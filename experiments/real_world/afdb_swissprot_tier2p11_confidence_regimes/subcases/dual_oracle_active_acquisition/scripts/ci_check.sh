...
echo "[5/6] aggregate (canonical v2.9: two-key gate + policy-card claims overlay)"
python "${CASE_DIR}/scripts/aggregate.py" \
...
echo "CI-style check PASSED (canonical v2.9)."
