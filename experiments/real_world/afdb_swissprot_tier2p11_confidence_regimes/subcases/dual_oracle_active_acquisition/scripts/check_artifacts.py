...
# v2.9 (canonical): ensure claims overlay applied to all policy cards
...
for pol in pt["policy"].astype(str).tolist():
    ...
    print("OK: canonical v2.9 artifacts + leakage pass + bilevel two-key gate + audit columns + graded claims + policy-card overlay present.")
