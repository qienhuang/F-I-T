# REPRO_CHECKLIST — Dual‑Oracle Active Acquisition (v0.5)
...
- `decision_trace.csv` records the acquisition score components:
  - `uncertainty`, `novelty`, `novelty_norm`, `composite_score`
- Budgets respected per oracle (or stop because pool exhausted)
