...
def main() -> None:
    ...
    lines: List[str] = []
    lines.append("# Eval report — Dual‑Oracle + Δ‑Lag + Leakage Audit (v1.5)\n\n")
    ...
    footer = (
        f"subcase=dual_oracle_active_acquisition_v1_5 | parent=afdb_swissprot_tier2p11_confidence_regimes | "
