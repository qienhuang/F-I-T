...
| metric | value |
|---|---:|
| cost_to_joint_usable | 150.000000 |
| total_cost_final | 150.000000 |
...
| final_mae_c3_hat | 0.515876 |

## Evidence plots

![Cost-aware learning curve](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_learning_cost.png)

![Allocation cost share](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_allocation_cost.png)

![Holdout TPR vs FPR target](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_tpr_vs_fpr.png)

![FPR-floor dynamics](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_fpr_floor.png)

![Joint coverage timeline (round)](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_joint_cov_round.png)

![Joint coverage timeline (cost)](assets/adaptive_joint_gap__composite_batch_ff_uK__a0.7__K5000_joint_cov_cost.png)
