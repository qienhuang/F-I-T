...
policy_df.to_csv(run_dir / "policy_table.csv", index=False)
    ...
    lines: List[str] = []
    lines.append("# Eval report — Dual‑Oracle + Δ‑Lag + Leakage Audit (v1.2)\n\n")
    ...
    footer = (
        f"subcase=dual_oracle_active_acquisition_v1_2 | parent=afdb_swissprot_tier2p11_confidence_regimes | "
