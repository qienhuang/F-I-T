...
> **Status: ESTIMATOR_UNSTABLE** - Coherence gate FAILED.
> 
> **WARNING:** Change points below are NOT interpretable.
> They are reported for diagnostic purposes only.
...
| Label | Meaning |
|-------|---------|
| `ESTIMATOR_UNSTABLE` | Coherence gate failed; change points not interpretable (current) |
