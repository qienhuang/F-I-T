...
4. Reference for context (if present in workspace): internal review notes (not for publishing).
...
- Do not add internal drafts, personal notes, or non-public datasets to `github/F-I-T/` unless explicitly approved.
...
- Do NOT add "Generated by an LLM" or similar per-file footnotes to artifacts.
